...
最終更新: 2026-09-21 00:21:08（このページはGitHub Actionsが自動生成しています）

## 🟡 水防団待機水位を超過

- 現在水位: **4.16 m**（観測: 2026-09-21 00:10:00）
- 今後3時間の予測降水量（藤沢市周辺）: 約0.8 mm（出典: [Open-Meteo](https://open-meteo.com/)）

## 水位グラフ（実測・予想）

![境川橋の水位グラフ（実測・予想）](assets/chart.svg?v=20260921002108)
...
水位が上昇傾向のため、最新映像を掲載しています（撮影時刻: 2026-09-21 00:14:00）。

![境川橋付近の河川カメラ映像](assets/camera_20260921_001400.jpg)
...
|---|---|---|
| 水防団待機水位 | 4.00 m | 超過済み |
| 氾濫注意水位 | 4.50 m | 3時間以内では未達予定（予測ピークは約4.32m、あと0.18m） |
| 避難判断水位 | 5.20 m | 3時間以内では未達予定（予測ピークは約4.32m、あと0.88m） |
| 氾濫危険水位 | 5.65 m | 3時間以内では未達予定（予測ピークは約4.32m、あと1.33m） |
