...
最終更新: 2026-09-23 09:22:23（このページはGitHub Actionsが自動生成しています）

## 🟢 平常（各警戒水位未満）

- 現在水位: **1.60 m**（観測: 2026-09-23 09:10:00）
- 今後3時間の予測降水量（藤沢市周辺）: 約1.6 mm（出典: [Open-Meteo](https://open-meteo.com/)）

## 水位グラフ（実測・予想）

![境川橋の水位グラフ（実測・予想）](assets/chart.svg?v=20260923092223)
