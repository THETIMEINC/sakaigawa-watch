...
最終更新: 2026-09-22 10:06:15（このページはGitHub Actionsが自動生成しています）

## 🟢 平常（各警戒水位未満）

- 現在水位: **1.97 m**（観測: 2026-09-22 10:00:00）
- 今後3時間の予測降水量（藤沢市周辺）: 約0.0 mm（出典: [Open-Meteo](https://open-meteo.com/)）

## 水位グラフ（実測・予想）

![境川橋の水位グラフ（実測・予想）](assets/chart.svg?v=20260922100615)
...
| 段階 | 水位 | 到達予想 |
|---|---|---|
| 水防団待機水位 | 4.00 m | 3時間以内では未達予定（予測ピークは約2.35m、あと1.65m） |
| 氾濫注意水位 | 4.50 m | 3時間以内では未達予定（予測ピークは約2.35m、あと2.15m） |
| 避難判断水位 | 5.20 m | 3時間以内では未達予定（予測ピークは約2.35m、あと2.85m） |
| 氾濫危険水位 | 5.65 m | 3時間以内では未達予定（予測ピークは約2.35m、あと3.30m） |
