...
最終更新: 2026-09-21 00:30:05（このページはGitHub Actionsが自動生成しています）

## 🟡 水防団待機水位を超過

- 現在水位: **4.12 m**（観測: 2026-09-21 00:20:00）
- 今後3時間の予測降水量（藤沢市周辺）: 約0.8 mm（出典: [Open-Meteo](https://open-meteo.com/)）

## 水位グラフ（実測・予想）

![境川橋の水位グラフ（実測・予想）](assets/chart.svg?v=20260921003005)
...
水位が上昇傾向のため、最新映像を掲載しています（撮影時刻: 2026-09-21 00:24:00）。

![境川橋付近の河川カメラ映像](assets/camera_20260921_002400.jpg)
